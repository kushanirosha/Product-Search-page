...
export default function RootLayout({
  ...
  return (
    <html suppressHydrationWarning lang="en">
      ...
      >
        <Providers themeProps={{ attribute: "className", defaultTheme: "dark" }}>
          <div className="relative flex flex-col h-screen">
            <Navbar />
            <main className="">
              {children}
            </main>
            <footer className="p-4 bg-slate-400 sm:p-6 dark:bg-gray-800">
              <div className="mx-auto max-w-screen-xl pt-9">
